...
export const categoryListTableColumns = (props: CategoryListTableColumnsProps) =>
  [
    {
      ...
      key: 'category_title',
      render: (text: string, record: CategoryEntity) => creatCategoryTitleByDepth(text, record),
    },
    {
      title: '分类英文名',
    ...
    },
    {
      ...
      key: 'operation',
      width: 100,
      render: (text: string, record: CategoryEntity) => (
        <p>
  ...
  ] as Pick<TableProps<CategoryEntity>, 'columns'>;

...
const Media = () => {
  ...
  const onDeleteItem = (id) => {
    mediaModel.distory(id)
  }

  const handelSwitchTab = (value) => {
  ...
  return (
    <Card>
      <Tabs activeKey={mediaModel.tab} onChange={handelSwitchTab}>
              ...
              <When condition={mediaModel.list.length !== 0}>
                <div className={styles.mediaList}>
                  <ul className={styles.mediaItems}>
                    <For each="item" of={mediaModel.list}>
                      <li
                        className={
                          item._id === currentItem._id ? styles.mediaItemActive : styles.mediaItem
                        }
                        key={item._id}
                        ...
                        <Choose>
                          <When
                            condition={
                              ...
                              currentItem.media_type.indexOf('image') !== -1
                            }
                          >
